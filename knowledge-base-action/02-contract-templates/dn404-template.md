# DN404 - Hybrid ERC20/ERC721 Template

**Type:** Hybrid Token-NFT Standard

**Published:** 2023

**GitHub:** [vectorized/dn404](https://github.com/vectorized/dn404)

## Overview

DN404 is an implementation of a co-joined ERC20 and ERC721 pair. It provides:

- **Full ERC20 Compliance:** Standard token functionality
- **Full ERC721 Compliance:** NFT functionality
- **Synchronized Transfers:** Transfers on one side reflect on the other
- **Highly Optimized:** Gas-efficient implementation
- **Experimental:** Cutting-edge implementation with thorough testing

## Key Features

### Dual Standard Compliance
- ✅ Complete ERC20 token support
- ✅ Complete ERC721 NFT support
- ✅ Integrated transfer mechanisms
- ✅ Unified accounting system

### Advanced Properties
- **Co-joined Mechanics:** Token and NFT sides are synchronized
- **Gas Optimization:** Heavily optimized for minimal gas consumption
- **Flexible Architecture:** Works with upgradeable and non-upgradeable contracts
- **Mirror Architecture:** Separate ERC721 contract mirrors ERC20 logic

### Use Cases
- Hybrid tokens with NFT fractionalization
- NFTs with token backing
- Community tokens with NFT membership
- Dual-utility assets
- Tokenized NFT collections

## Smart Contracts

### DN404.sol
The main ERC20 contract that manages:
- Token transfers and balances
- Token allowances
- Mirror contract integration
- Synchronization with NFT side

**Size:** 63017 bytes
**Lines:** 1501

### DN404Mirror.sol
The ERC721 contract that manages:
- NFT ownership and transfers
- ERC721 metadata
- Synchronization with token side
- Mirror address delegation

**Size:** 22742 bytes
**Lines:** 543

### SimpleDN404.sol (Example)
A minimal example implementation showing:
- Basic DN404 initialization
- ERC20-focused usage
...
### NFTMintDN404.sol (Example)
An advanced example showing:
- ERC721-focused usage
- NFT minting capabilities
- Custom DN404 patterns
...
### Architecture
```
SimpleDN404/NFTMintDN404 (ERC20)
    ↓
DN404 (Core Logic)
    ↕ (Synchronized)
DN404Mirror (ERC721)
...
1. **Co-joined State:** Token and NFT balances are synchronized
2. **Mirror Pattern:** ERC721 is implemented as a mirror of ERC20
3. **Gas Optimization:** Lazy minting and efficient data structures
4. **Flexibility:** Supports both upgradeable and immutable deployments

## Vulnerabilities Prevented

- ✅ Overflow/Underflow (Solidity 0.8+)
- ✅ Double-spending in dual standards
- ✅ Transfer inconsistencies between standards
- ✅ Authorization issues in dual-standard context

## Integration Guidelines

### When to Use DN404
- You need both ERC20 tokens and ERC721 NFTs
- You want synchronized token/NFT mechanics
- You need gas-optimized hybrid functionality
- You're building community tokens with NFT membership
...
- Most DN404 contracts are upgradeable-compatible
- Call required internal initialization methods
- Test thoroughly with your upgrade mechanism

## Related Vulnerabilities Protected Against

- **Overflow/Underflow:** Solidity 0.8+ built-in protection
- **Reentrancy:** Standard transfer guards
- **Double-Spending:** Synchronized state prevents dual-standard issues
- **Authorization:** Dual-standard authorization checks

## References

**Documentation:** [DN404 README](https://github.com/vectorized/dn404/blob/main/README.md)

**Repository:** [vectorized/dn404](https://github.com/vectorized/dn404)
...
Inspired by:
- Serec (@SerecThunderson)
- Solady (github.com/vectorized/solady)
- ERC721A (github.com/chiru-labs/ERC721A)

---

**Type:** Hybrid Token-NFT Standard
**Standard Compliance:** ERC20 + ERC721
**Gas Optimized:** Yes
**Upgradeable:** Compatible
**Status:** Experimental (Production Ready with Testing)

Source: [marcelc63/dn404](https://github.com/marcelc63/dn404)
