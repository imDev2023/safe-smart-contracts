...
As we discussed in the [General Philosophy](https://consensysdiligence.github.io/smart-contract-best-practices/general-philosophy/) section, it is not enough to protect yourself against the known attacks. Since the cost of failure on a blockchain can be very high, you must also adapt the way you write software, to account for that risk.
