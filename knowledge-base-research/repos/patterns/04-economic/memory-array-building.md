...
**Category:** Economic Pattern (Gas Optimization)

**Source:** https://fravoll.github.io/solidity-patterns/memory_array_building.html
...
An implementation of this pattern can be found in the infamous [CryptoKitties contract](https://etherscan.io/address/0x06012c8cf97bead5deae237070f9587f8e7a266d/#code). In line 651 we find a function called `tokensOfOwner(address _owner)` which returns the IDs of all Kitties that belong to a given address.
